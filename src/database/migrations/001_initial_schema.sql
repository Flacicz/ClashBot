...
CREATE INDEX IF NOT EXISTS idx_clanwar_seasons_clan_tag ON clanwar_seasons (clan_tag);
...
CREATE INDEX IF NOT EXISTS idx_clanwar_summary_season_id ON clanwar_summary (season_id);
...
CREATE INDEX IF NOT EXISTS idx_clanwar_league_rounds_season_id ON clanwar_league_rounds (season_id);
